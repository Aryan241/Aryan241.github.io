...
<script>
  console.log("%c🛑 WAIT A MINUTE!", "color: red; font-size: 30px; font-weight: bold;");
  console.log("%cAre you trying to steal my CSS, or did you just break something? Either way, welcome!", "font-size: 14px;");
</script>
